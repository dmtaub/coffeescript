...
// multiline need to be indented.
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      constructor(name1, value1, splat1, type1) {
        var message, token;
        super();
        this.name = name1;
        this.value = value1;
      ...
      compileToFragments(o) {
        var commentFragments, commentsNode;
        this.name.compileToFragments(o, LEVEL_LIST);
        if (this.type != null) {
          commentsNode = new Value(this.type);
          commentFragments = [];
          this.compileCommentFragments(o, commentsNode, commentFragments);
          return o.scope.comments[this.name.value] = commentFragments;
        }
      }
